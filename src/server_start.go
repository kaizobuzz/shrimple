...
func Start_Server() {
    ...
    http.HandleFunc("/api/v1/changepassword", passwordChangeHandler)
    ...
    http.HandleFunc("/api/v1/privacysettings", getPrivacySettings)
    http.HandleFunc("/api/v1/changeprivacysettings", changePrivacySettings)
